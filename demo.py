...
def set_argparse():
    ...
    parser.add_argument('--img_mode', type=str, default='t2', help='medical images mode')
    parser.add_argument('--prev_img_mode', type=str, default='t2', help='previous medical images mode')
